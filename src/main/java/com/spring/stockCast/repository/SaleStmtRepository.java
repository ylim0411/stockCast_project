...
public class SaleStmtRepository {
    ...
    // 전체 수
    public int saleCount(Integer storeId) {
        return sql.selectOne("SaleStmt.saleCount",storeId);
    }
    // 발주번호 검색 + 페이징
    ...
    // 발주 번호 검색
    public int countByNo(Map<String, Object> param) {
        return sql.selectOne("SaleStmt.countByNo", param);
    }
    // 날짜 검색 + 페이징
