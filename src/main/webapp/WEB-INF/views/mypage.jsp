...
<html lang="en">
  ...
  <body>
    <div class="container">
      ...
      <div class="section-wrap85" style="display: flex; flex-direction: column; gap: 10px">
        <!-- section-box1 관리자 정보 -->
        <form action="/admin/update" method="post">
          ...
          <div class="section-box section-box1" style="height: 200px; min-height: 200px; margin: 0">
                ...
                <div class="col">
                  ...
                  <p class="value" style="position: relative">
                    <input
                      ...
                      readonly
                      required
                      style="text-align: center; height: 30px; outline: none; width: 80%; border: none; font-size: 16px"
                    />
                    <button
                      type="button"
            ...
            <c:forEach var="store" items="${storeList}">
              <form method="post" action="${pageContext.request.contextPath}/store/update" class="store-form">
                ...
                <div class="mypage-item">
                  ...
                  <!-- 주소 -->
                  <div>
                    <input type="text" name="storeAddress" value="${store.storeAddress}" readonly />
                  </div>
                  <!-- 전화번호 -->
                  <div>
                    <input
