        ...
        <div class="login-text">
          <form action="/admin/login" method="post">
            ...
            >
              <img
                id="togglePwIcon"
                src="${pageContext.request.contextPath}/static/images/eye-open.png"
                alt="보기"
    ...
    <script>
      function togglePassword() {
        ...
        if (pwField.type === "password") {
          pwField.type = "text";
          icon.src = `${pageContext.request.contextPath}/static/images/eye-close.png`; // 열린 눈

          icon.alt = "숨기기";
        } else {
          pwField.type = "password";
          icon.src = `${pageContext.request.contextPath}/static/images/eye-open.png`; // 닫힌 눈
          icon.alt = "보기";
        }
      }
      // 로그인 실패시 alert 띄우기
